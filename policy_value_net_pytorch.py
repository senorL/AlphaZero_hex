...
class PolicyValueNet():
    ...
    def __init__(self, board_width, board_height,
        ...
        if model_file:
            print(f"Loading model parameters from file: {model_file}")
            ...
            self.policy_value_net.load_state_dict(model_dict)
            # self.policy_value_net.load_state_dict(torch.load(model_file, map_location=torch.device('cpu')))
